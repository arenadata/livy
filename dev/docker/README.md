...
This generates a zip file for livy similar to `assembly/target/apache-livy-0.8.0.2-4.2.0-0_2.12-bin.zip`. It's useful to use the `clean` target to avoid mixing with previously built dependencies/versions.
