...
```
This generates a zip file for livy similar to `assembly/target/apache-livy-0.9.0.1-4.3.0-0_2.12-bin.zip`. It's useful to use the `clean` target to avoid mixing with previously built dependencies/versions.
